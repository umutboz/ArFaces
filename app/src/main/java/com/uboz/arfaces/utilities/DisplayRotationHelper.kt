package com.uboz.arfaces.utilities
...
class DisplayRotationHelper(context: Context) :
    ...
    /** Registers the display listener. Should be called from [//Activity#onResume()][//Activity.onResume].  */
    fun onResume() {
        displayManager.registerDisplayListener(this, null)
    }

    /** Unregisters the display listener. Should be called from [//Activity#onPause()][//Activity.onPause].  */
    fun onPause() {
